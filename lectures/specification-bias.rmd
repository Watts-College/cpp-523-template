...
plot( npos$POP, log(npos$NPOs+1), pch=19, cex=0.75, bty="n", col="darkorange",
      main="Linear-Log Model", xlab="Metro Population", ylab="Number of Nonprofits (logged)" )
...
effects can only be interpreted over a very local range of X values.
...
compounding rates of return. If we are not accustomed to working with
